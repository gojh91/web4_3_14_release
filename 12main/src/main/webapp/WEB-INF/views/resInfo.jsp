...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/resinfo/vendor/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/resinfo/vendor/slick.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/resinfo/css/util.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/resinfo/css/main.css?ver=6">
...
<div class="container bgwhite p-t-35 p-b-80">
					...
					<div class="wrap-slick3-dots">
						<ul class="slick3-dots" role="tablist">
							<li class="slick-active" role="presentation">
								 ...
								 <img src="${pageContext.request.contextPath}${resInfo.res_imgSrc1}" id="imagebutton1" onclick = "clickImg(1)">
							</li>
							<li role="presentation" >
								<div class="slick3-dot-overlay"></div>
								<img src="${pageContext.request.contextPath}${resInfo.res_imgSrc2}" id="imagebutton2" onclick = "clickImg(2)">
							</li>
							<li role="presentation">
								<div class="slick3-dot-overlay"></div>
								<img src="${pageContext.request.contextPath}${resInfo.res_imgSrc3}" id="imagebutton3" onclick = "clickImg(3)">
							</li>
						</ul>
					</div>
		...
		<br> <br> <a href="reviewList.do"></a> <br>
...
<!--===============================================================================================-->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/resinfo/vendor/bootstrap.min.js"></script>
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/resinfo/vendor/slick.min.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/resinfo/vendor/slick-custom.js"></script>
<!--===============================================================================================-->
	<script>
