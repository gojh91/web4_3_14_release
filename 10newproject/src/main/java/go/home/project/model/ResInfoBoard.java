...
public class ResInfoBoard {
	...
	// ResInfo
	private int gubun; 		    // Íµ¨Î∂Ñ 
	private int res_num; 		// Í∞?Í≤åÎ≤à?ò∏					
	private String res_name;		// ?ù¥Î¶?
	private String res_addr;		// Ï£ºÏÜå					
	private String res_phone;	// ?†Ñ?ôîÎ≤àÌò∏
	private String res_foodType;	// ?ùå?ãùÏ¢ÖÎ•ò
	private String res_price;		// Í∞?Í≤?
	private String res_parking;  // Ï£ºÏ∞®	
	private String res_bHour;	// ?òÅ?óÖ?ãúÍ∞?
	private int res_likeCnt;	// Ï∂îÏ≤ú?àò
	private double res_score;		// ?èâ?†ê
	private int res_reviewCnt;	// Î¶¨Î∑∞?àò	
	private String res_imgSrc1;	// ?Ç¨?†Ñ???û•Í≤ΩÎ°ú
