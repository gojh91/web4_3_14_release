...
<title>회원정보삭제 - MEAL-TING</title>
</head>
<body>

<br /><br /><br /><br /><br /><br />
<h2 align="center" class="titleFont" style="font-size:2em;">회원정보 삭제</h2>
<br />
<c:if test="${msg!=null}">${msg}</c:if>

<div align="center">
  <div style="width: 800px;">
	<form action="memberDelete.do?mb_id=${mb_id}" method="post">
		<fieldset class="boundBox">	
		<br />
		<p>아이디 ${mb_id } 를 삭제 하시겠습니까?</p><br />	
