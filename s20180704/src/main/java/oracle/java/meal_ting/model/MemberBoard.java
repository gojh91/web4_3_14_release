...
public class MemberBoard {
	...
	private String mb_name;	// 성명
	private String mb_imgSrc;	// 사진 경로
	private String mb_sex;	// 성별(1:남성 2:여성 9:비공개)
	private String mb_phone;	// 전화번호
	private Date mb_birthDate;	// 생년월일
	private String mb_email;	// 이메일
	private String mb_province;	// (주소) 도
	private String mb_city;		// (주소) 시
	private String mb_borough;	// (주소) 구
	private String mb_remark;	// 기타
	private String mb_authority;	// 작업권한(1:일반사용자 2:관리자)
	private String mb_status;	// STATUS (1:Active 2:Inactive 3:Delete)
	private Date mb_regDate;	// 가입일자
	private Date mb_wdDate;	// 탈퇴일자
