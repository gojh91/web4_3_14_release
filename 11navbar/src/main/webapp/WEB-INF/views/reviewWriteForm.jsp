...
<!-- Stylesheets -->
<link href="${pageContext.request.contextPath}/resources/reviewWrite/bootstrap.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/reviewWrite/ionicons.css" rel="stylesheet">

<link href="${pageContext.request.contextPath}/resources/reviewWrite/css/styles.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/reviewWrite/css/responsive.css" rel="stylesheet">
</head>
<style>
               ...
               <div class="comment-form">
                  <form action="reviewInsert.do" method="get">
                     <div class="row">
                        ...
                        <div class="col-sm-6">
                           <p>아이디</p><br>
                           <input type="text" aria-required="true" name="mb_id" class="form-control" value="${loginMember.mb_id}" aria-invalid="true">
                        </div>
                        <div class="col-sm-6">
                           <p>가게 이름</p><br>
                        ...
                        <div class="col-sm-6">
                           <p>평점</p><br>
                           <input type="number" aria-required="true" name="bd_score" class="form-control" value="${res_score}" aria-invalid="true" >
                        </div> 
